...
<head>
    ...
    <title>Kuisioner Wednesday - Netflix</title>
        ...
        <div class="max-w-3xl w-full">
            <div class="bg-black bg-opacity-80 backdrop-blur-xl rounded-3xl p-8 sm:p-12 border border-gray-700 border-opacity-30 shadow-2xl">
                <div class="text-center mb-8">
                    ...
                    <div class="text-sm text-gray-400 mb-2">3/6</div>
                    <h2 class="text-2xl sm:text-3xl font-bold mb-4">Pernah Nonton Wednesday?</h2>
                </div>

                <form id="quizForm">
                    <input type="hidden" name="film" value="wednesday">
                ...
                if (data.success) {
                    setTimeout(() => {
                        if (selectedValue === 'belum') {
                            ...
                            window.location.href = 'quiz-wednesday-season.php';
                        }
                    }, 1000);
                }
            })
